...
You can even edit a page directly on github by clicking the edit button ([for example this page](https://github.com/matthid/Yaaf.Logging/blob/develop/Contributing.md)).
...
This project is subject to the terms and conditions defined in file ['LICENSE.md'](https://github.com/matthid/Yaaf.Logging/blob/develop/LICENSE.md), which is part of this source code package.
